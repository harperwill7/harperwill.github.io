// (MODIFIED to include booking route)
...
// **NEW ROUTE**: For handling the transactional booking
router
    .route('/trips/:tripCode/book')
    .post(authenticateJWT, tripsController.tripsBookTrip); // <-- ADDED
